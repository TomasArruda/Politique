...
urlpatterns = [
    ...
    url(r'^EditarEventoInstitucional/(?P<id>.+)/$', views.EditarEventoInstitucionalView, name='EditarEventoInstitucional'),
    url(r'^EditarCapacitacaoInterna/(?P<id>.+)/$', views.EditarCapacitacaoInternaView, name='EditarCapacitacaoInterna'),
    url(r'^EditarCapacitacaoExterna/(?P<id>.+)/$', views.EditarCapacitacaoExternaView, name='EditarCapacitacaoExterna'),
    url(r'^RemoverEventoInstitucional/(?P<id>.+)/$', views.RemoverEventoInstitucionalView, name='RemoverEventoInstitucional'),
    url(r'^RemoverCapacitacaoInterna/(?P<id>.+)/$', views.RemoverCapacitacaoInternaView, name='RemoverCapacitacaoInterna'),
    url(r'^RemoverCapacitacaoExterna/(?P<id>.+)/$', views.RemoverCapacitacaoExternaView, name='RemoverCapacitacaoExterna'),

...
class Iniciativa(models.Model):
	...
	questoesChaves = models.CharField(max_length=100, blank=False, default='', null=False)
	...
	parceiros = models.CharField(max_length=100, blank=False, default='', null=False)
	principaisProgramas = models.CharField(max_length=100, blank=False, default='', null=False)
